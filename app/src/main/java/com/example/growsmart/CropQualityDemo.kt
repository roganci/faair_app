...
class CropQualityDemo : AppCompatActivity(), View.OnClickListener {
    companion object {
        const val TAG = "TFLite - ODT"
        const val REQUEST_IMAGE_CAPTURE: Int = 1
        private const val MAX_FONT_SIZE = 160F
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_crop_quality_demo)

//        captureImageFab = findViewById(R.id.captureImageFab)
        inputImageView = findViewById(R.id.weed_imageView)
    ...
    private fun drawDetectionResult(
        ...
        detectionResults.forEach {
            ...
            canvas.drawText(
                ...
                box.top + tagSize.height().times(3F), pen
            )
        }
        return outputBitmap
    }
