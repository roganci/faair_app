...
class DevelopmentStages : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_developmental_stages)
        val camera = findViewById<Button>(R.id.ds_picture_btn)
        val gallery = findViewById<Button>(R.id.ds_gallery_btn)
        result = findViewById(R.id.result)
        imageView = findViewById(R.id.develop_imageView)
    ...
    fun classifyImage(image: Bitmap?) {
        try {
            ...
            val classes =
                arrayOf("Ready to Harvest", "Seedlings", "Approaching Maturity")
